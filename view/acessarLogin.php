...
<div class="container mb-5 text-center"><br>
    ...
    <br>
    <a class="btn btn-primary" href="loginUser.php" role="button">Usuário</a>&nbsp;
    <a class="btn btn-success" href="loginCentroAutomotivo.php" role="button">Centro Automotivo</a>&nbsp;
    <a class="btn btn-danger" href="loginAdmin.php" role="button">Administração</a>
</div>
