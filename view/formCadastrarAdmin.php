...
<h1 class="text-center text">Cadastrar Administrador</h1>
<small style="font-size: 8pt;" class="text">campos com (*) são obrigatórios</small>    
<form method="post" action="../controller/CadastrarAdmin.php" onsubmit="return verificaSenha();">
    <br> 
    <div class="form-group">
        ...
        <div class="row">
            <div class="col-6">
                ...
                <input type="text" name="cel" id="cel" class="form-control" required onkeyup="mascara('(##)#####.####',this,event,true)" placeholder="(##)#####-####"/>
            </div>
        </div>
        <hr>
        <div class="row">
        ...
        <div class="d-flex justify-content-center">
            <button class="btn btn-outline-primary" type="submit" style="margin-top: 15px;">Cadastrar</button>
        </div>
    </div>
    </form>
</div>
