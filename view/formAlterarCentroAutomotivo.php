...
<form method="post" action="../controller/AlterarCentroAutomotivoController.php" onsubmit="return verificaSenha();"/>
    <input type="hidden" name="idcentroautomotivo" value="<?php echo $centro["idCentro"]?>"/>        
<div class="container mb-5">
        <div class="form-group">
            ...
            <div class="row">
                <div class="col-sm">
                    ...
                    <hr>
                    <h5 class="text text-center">Acesso</h5>
                    <hr>
                </div>
            </div>
            <div class="row">
